pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.81.110.152:9091/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Sathvik31060/practical3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.81.110.152:9091/springapp1"
            echo "✅ Frontend deployed: http://54.81.110.152:9091/frontapp1"
        }
        failure {
