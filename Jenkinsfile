pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://3.90.165.231:9091/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://3.90.165.231:9091/springapp1"
            echo "✅ Frontend deployed: http://3.90.165.231/frontapp1"
        }
        failure {
